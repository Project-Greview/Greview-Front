...
const LeftMenu = () => {
  ...
  return (
    <LeftMenuSection.ActiveBackground
      className={leftMenuState !== true ? "" : "active"}
    >
      <LeftMenuSection.LeftMenuFrame
        className={leftMenuState !== true ? "" : "active"}
      >
        <div className="profil_info flex flex_dir_c">
          <div className="left_menu_header flex flex_jc_sb flex_ai_c">
            ...
            >
              ...
              >
                <path
                  d="M11.8333 1.34199L10.6583 0.166992L5.99999 4.82533L1.34166 0.166992L0.166656 1.34199L4.82499 6.00033L0.166656 10.6587L1.34166 11.8337L5.99999 7.17533L10.6583 11.8337L11.8333 10.6587L7.17499 6.00033L11.8333 1.34199Z"
                  fill="#959292"
                />
              </svg>
            </div>
          ...
          <ProfileImage />
          <ul className="short_info flex flex_dir_c flex_jc_c flex_ai_c">
            <li className="nickname">UserNickname</li>
            <li className="location">UserLocation</li>
          </ul>

          <ul className="short_review_info flex flex_jc_sa flex_1_0_0">
            <li className="review">
              <div className="txt">리뷰</div>
