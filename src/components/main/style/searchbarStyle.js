...
export const SearchBarSection = {
  SearchFrame:styled.div`
    position:absolute; display: flex; justify-content: space-between; align-items: center; flex-basis:100%; width:100%; top:0; left:0; padding:0.8rem 0; background:#ffffff; z-index:5;
